...
// swap operator
template <class Type>
void TwoWayList<Type>::Swap(TwoWayList &List)
{
...
// copy from operator
template <class Type>
void TwoWayList<Type>::CopyFrom(TwoWayList &List)
{
...
template <class Type>
int TwoWayList<Type>::Length()
{
	return (list->leftSize + list->rightSize);
}

template <class Type>
bool TwoWayList<Type>::AtStart()
{
	return (list->leftSize == 0);
}

template <class Type>
bool TwoWayList<Type>::AtEnd()
{
...
template <class Type>
void TwoWayList<Type>::Append(Type &Item)
{
	MoveToFinish();
	Insert(Item);
}
