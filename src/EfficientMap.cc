...
// swap operator
template <class Key, class Data>
void EfficientMap<Key, Data>::Swap(EfficientMap &List)
{
...
template <class Key, class Data>
void EfficientMap<Key, Data>::MoveToStart()
{
	list->current = list->first;
}

template <class Key, class Data>
bool EfficientMap<Key, Data>::AtStart()
{
...
// make the first node the current node
template <class Key, class Data>
void EfficientMap<Key, Data>::MoveToFinish()
{
	list->current = list->last->previous;
}

template <class Key, class Data>
void EfficientMap<Key, Data>::Advance()
{
...
template <class Key, class Data>
void EfficientMap<Key, Data>::Retreat()
{
...
template <class Key, class Data>
void EfficientMap<Key, Data>::Advance(int whichLevel)
{
...
template <class Key, class Data>
void EfficientMap<Key, Data>::Insert(Node *temp, int whichLevel)
{
...
template <class Key, class Data>
bool EfficientMap<Key, Data>::AtEnd()
{
	return (list->current->next[0] == list->last);
}

template <class Key, class Data>
int EfficientMap<Key, Data>::AtEnd(int whichLevel)
{
	return (list->current->next[whichLevel] == list->last);
}

template <class Key, class Data>
void EfficientMap<Key, Data>::Clear(void)
{
...
template <class Key, class Data>
int EfficientMap<Key, Data>::Remove(Key &key, Key &removedKey, Data &removedData)
{
	MoveToStart();
...
template <class Key, class Data>
int EfficientMap<Key, Data>::IsThere(Key &key)
{
	MoveToStart();
...
template <class Key, class Data>
void EfficientMap<Key, Data>::Insert(Key &key, Data &data)
{
	MoveToStart();
...
template <class Key, class Data>
void EfficientMap<Key, Data>::SuckUp(EfficientMap<Key, Data> &other)
{
...
template <class Key, class Data>
int EfficientMap<Key, Data>::Length()
{
	int length = 0;
...
template <class Key, class Data>
void EfficientMap<Key, Data>::CopyFrom(EfficientMap<Key, Data> &other)
{
...
template <class Key, class Data>
Key &EfficientMap<Key, Data>::CurrentKey()
{
...
template <class Key, class Data>
Key &EfficientMap<Key, Data>::CurrentKey(int whichLevel)
{
...
template <class Key, class Data>
void EfficientMap<Key, Data>::Remove(Node *&removeMe, int whichLevel)
{
