...
void InefficientMap<Key, Data>::SuckUp(InefficientMap &suckMe)
{
...
template <class Key, class Data>
void InefficientMap<Key, Data>::Swap(InefficientMap &withMe)
{
	container.Swap(withMe.container);
}

template <class Key, class Data>
void InefficientMap<Key, Data>::CopyFrom(InefficientMap<Key, Data> &other)
{
...
template <class Key, class Data>
int InefficientMap<Key, Data>::Length()
{
...
template <class Key, class Data>
void InefficientMap<Key, Data>::Insert(Key &insertKey, Data &insertData)
{
	Node foo;
...
template <class Key, class Data>
int InefficientMap<Key, Data>::IsThere(Key &findMe)
{
...
template <class Key, class Data>
void InefficientMap<Key, Data>::Clear(void)
{
	MoveToStart();
	while (!AtEnd())
	{
...
template <class Key, class Data>
int InefficientMap<Key, Data>::Remove(Key &findMe, Key &putKeyHere,
																			Data &putDataHere)
{
...
template <class Key, class Data>
Key &InefficientMap<Key, Data>::CurrentKey() { return container.Current().key; }
...
template <class Key, class Data>
void InefficientMap<Key, Data>::Advance() { container.Advance(); }

template <class Key, class Data>
void InefficientMap<Key, Data>::Retreat() { container.Retreat(); }

template <class Key, class Data>
void InefficientMap<Key, Data>::MoveToStart() { container.MoveToStart(); }

template <class Key, class Data>
void InefficientMap<Key, Data>::MoveToFinish() { container.MoveToFinish(); }

template <class Key, class Data>
bool InefficientMap<Key, Data>::AtStart() { return container.AtStart(); }

template <class Key, class Data>
bool InefficientMap<Key, Data>::AtEnd() { return container.AtEnd(); }
